...
详细 FAQ 和场景说明见 [docs/user-guide.md](docs/user-guide.md)。快速判断如下：
...
- Q. AI 太频繁请求批准。
  A. 如果已批准的 packet 边界很清楚，可以提高到
  `Level 2 Work Packet Autonomy`。但 release、migration、destructive action、
  user data、auth、money、security、rollback gate 仍然需要 Owner approval。
- Q. AI 推进得太远。
  A. 降到 `Level 1 Unit Autonomy`，并缩小 work packet。让 AI 只完成一个
  unit，然后报告变更文件、检查证据、限制和仍需 Owner decision 的事项。
- Q. AI 只说 "done"。
...
- [docs/user-guide.md](docs/user-guide.md): 场景式用户指南和 FAQ
