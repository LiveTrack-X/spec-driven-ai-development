...
_REMEDIATIONS = {
    ...
    "state.schema.missing-version": "Declare version: 1 or version: 2 in sdad-state.yaml.",
    "state.schema.unsupported-version": "Use a supported state contract version (1 or 2).",
