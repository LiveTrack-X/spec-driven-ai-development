...
especially when a project has long SPECs, old handoffs, active TODOs, and
multiple reviewers. This document turns those assumptions into explicit project
rules.
...
현재가 과거보다 우선하고, 증거가 자신감보다 우선하며, 활성 작업과 미래 아이디어는 섞지 않는다.
```
...
## 4. Small Verified Slices Beat Large Unverified Progress
...
## 5. Open Findings Beat New Features
...
## 6. Explicit Non-Goals Beat Assumptions
...
## 7. Stated Uncertainty Beats Silent Guessing
...
## 8. Degraded Or Partial Means Label It
...
## 10. Handoff Is Context, Not Authority
...
## 11. Archive Preserves Memory, Not Active Work
...
## 12. Version Lanes Beat Copy-Paste Sync
...
## 13. Release Readiness Beats Feature Count
...
## 14. Environment Limits Beat Overclaiming
...
## 15. Cross-Review Beats Single-Agent Finality
...
## 16. Owner Decision Beats AI Momentum
...
## 17. Scope-Specific Percent Beats Global Percent
...
## 18. Failing Or Missing Tests Beat Narrative
...
## 19. Risk Gates Beat Convenience
...
## 20. Repeated Pain Becomes A Rule
