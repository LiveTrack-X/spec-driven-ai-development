...
The stable v3.2.3 install sources are pinned by
[`install-sources.json`](../install-sources.json) to immutable behavior baseline
`04a3e24569758237b702c5a2fbc6094a186d6cb0`. See the
[v3.2.3 release notes](releases/v3.2.3.md) for the bounded change and evidence.
...
The guard identifies Doctor version 3.2.3. Doctor version, state schema version,
