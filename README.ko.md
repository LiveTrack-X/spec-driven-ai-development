...
운영 프로토콜입니다. 특정 구현 방법을 정하거나 에이전트를 실행하지 않고, 여러
AI 도구와 세션에서 범위, validation, evidence, unresolved state, 오너 권한이
일관되게 유지되도록 합니다. Markdown은 권한과 기대를 기록하지만 도구 사용을
